/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORKMF_H
#define AI_NETWORKMF_H

#include "networkmf_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORKMF_MODEL_NAME          "networkmf"
#define AI_NETWORKMF_ORIGIN_MODEL_NAME   "model_test"

/******************************************************************************/
#define AI_NETWORKMF_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORKMF_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORKMF_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORKMF_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORKMF_IN \
  ai_networkmf_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORKMF_IN_SIZE { \
  AI_NETWORKMF_IN_1_SIZE, \
}
#define AI_NETWORKMF_IN_SIZE_BYTES { \
  AI_NETWORKMF_IN_1_SIZE_BYTES, \
}
#define AI_NETWORKMF_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORKMF_IN_1_CHANNEL     (8)
#define AI_NETWORKMF_IN_1_SIZE        (8)
#define AI_NETWORKMF_IN_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_NETWORKMF_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORKMF_OUT \
  ai_networkmf_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORKMF_OUT_SIZE { \
  AI_NETWORKMF_OUT_1_SIZE, \
}
#define AI_NETWORKMF_OUT_SIZE_BYTES { \
  AI_NETWORKMF_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORKMF_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORKMF_OUT_1_CHANNEL     (5)
#define AI_NETWORKMF_OUT_1_SIZE        (5)
#define AI_NETWORKMF_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_NETWORKMF_N_NODES (6)
 ...
 * @ref ai_networkmf_create. Both the activations memory buffer 
 ...
 * using @ref ai_networkmf_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_networkmf_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_networkmf_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORKMF_*
 * defines into file @ref networkmf.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_networkmf_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORKMF_H */
